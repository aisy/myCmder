...
var scriptsVersion = argv.reason ? 'reason-react-native-scripts' : argv['scripts-version'];

createApp(commands[0], !!argv.verbose, scriptsVersion).then(function () {});
...
function packageManagerType() {
  var defaultType = 'npm';
  var supportedTypes = ['yarn', 'npm', 'pnpm'];

  if (packageManager) {
    var index = supportedTypes.indexOf(packageManager);
